...
def draw():
    global seviye, mod, puan, zorluk2, sesli, sessiz, sifirla, ses
...
def carpismalar():
    global mod, puan, seviye, zorluk2, dusman_sayisi, can, new_image, dusman1_can, dusman2_can, dusman4_can, sesli, sessiz, ses, sifirla
